    ...
    <div id="item">
        <div class="crumb-wrap">
            <ul class="sui-breadcrumb">
                <li>
                    <a href="javascript:;">${category1Name}</a>
                </li>
                <li>
                    <a href="javascript:;">${category2Name}</a>
                </li>
                <li>
                    <a href="javascript:;">${category3Name}</a>
                </li>
            </ul>
        </div>
        <!--product-info-->
            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
							<span class="jqzoom">
                            <#if (imageList?size > 0)>
                                <img width="400" height="400" jqimg="${imageList[0].url}" src="${imageList[0].url}"/>
                            </#if>
							</span>
                    </div>
                    <!--下方的缩略图-->
                    <div class="spec-scroll">
                        ...
                        <div class="items">
                            <ul>
                            <#list imageList as imge>
                                <li>
                                    <img src="${imge.url}" bimg="${imge.url}" onmousemove="preview(this)"/>
                                </li>
                            </#list>
                            </ul>
                        </div>
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <#list spec.attributeValue as val>
                                <#--class="selected"-->
                                <dd><a class="{{isSelected('${spec.attributeName}','${val}') ? 'selected' : ''}}" ng-click="selectSpecification('${spec.attributeName}','${val}')" href="javascript:;">${val}<span title="点击取消选择">&nbsp;</span></a></dd>
                            </#list>
                        </dl>
                        </#list>
                    </div>
